...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL?>" class="brand-link">
      <img src="<?php echo $URL;?>/public/img/carrito.jpg" alt="Logo carrito" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">sistematica21.com</span>
    </a>
